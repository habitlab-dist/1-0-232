(function(){
  ...
  out$.get_log_names = get_log_names = async function(){
    ...
    logs_list = ['goals', 'interventions', 'feedback', 'pages', 'enabledisable'].map(function(it){
      return 'logs/' + it;
    });
